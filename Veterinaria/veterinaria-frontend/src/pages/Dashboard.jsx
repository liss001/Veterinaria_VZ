...
import CalendarioCitas from "../components/CalendarioCitas"; // Asegúrate de tener este componente
...
export default function Dashboard() {
  ...
  const [citasComponente, setCitasComponente] = useState([]); // Para pasar al calendario
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        setCitasComponente(citasData); // Sin formatear, para el calendario
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-8">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow p-4">
          <h3 className="text-lg font-semibold text-gray-700 dark:text-white mb-4">Calendario de Citas</h3>
          <CalendarioCitas citas={citasComponente} />
        </div>
